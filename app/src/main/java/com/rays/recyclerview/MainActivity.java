package com.rays.recyclerview;

import android.graphics.drawable.Drawable;
import android.os.Bundle;
import android.os.Handler;

import com.rays.recyclerview.utils.CommonUtils;
import com.rays.recyclerview.utils.DividerItemDecoration;
...
public class MainActivity extends AppCompatActivity implements SportAdapter.Callback {
    ...
    private void setUp() {
        ...
        mSportAdapter = new SportAdapter(MainActivity.this,new ArrayList<>());
